...
<script lang="ts">
	...
	// MOVED HERE FROM TYPESETTING (FEAT-010 ADR-012): IT CONTROLS THE CHAPTER VIEW, NOT HOW TEXT IS LETTERED
...
<div class="space-y-6">
	...
	<div
		...
		class={`flex items-center justify-between gap-3 rounded-xl border border-black/10 bg-black/[0.02] p-3 dark:border-white/10 dark:bg-white/[0.02] transition-all duration-300 ${highlightedSettingId === 'live-pipeline-preview' ? 'ring-2 ring-[#b23a2e] dark:ring-[#e08a63] bg-[#b23a2e]/[0.06] dark:bg-[#e08a63]/[0.08]' : ''}`}
	>
		<div class="min-w-0">
