...
export function systemPrompt(
	...
	const coreInvariants: string[] = [
		...
		`       1) Character Annotation Tags & Status Labels: Concise descriptive callouts pointing to a character (e.g. status tags, traits, or gag commentary like [ 不看八卦新闻。 ], [ 刚刚睡醒 ], [ 沉迷游戏中 ]). Translate as concise declarative third-person or subjectless phrases (e.g. "Doesn't read gossip news.", "Just woke up.", "Lost in a game."). Do NOT default these to second-person ("you") address or questions.`,
