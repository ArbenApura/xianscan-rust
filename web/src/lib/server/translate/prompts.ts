...
- Stylized Shouts, Screams & Agony Groans: In dramatic action, suffering, or horror panels, elongated vertical screams and shouts (끄아아아악!!, 으아아아악!!, 크아아악!!, 끼아아악!!, 아아아악!!) often have their top/bottom strokes and exclamation marks misrecognized as random numbers, ASCII symbols, or trailing letters (e.g. "아\\n아\\n아\\n알\\n7\\n11\\n.\\n!!" -> "Aaaaargh!!", ":=우우우우ㅂ\\n!!" -> "Gwaaaah!!" / "Aaaaack!!"). Never translate these artifact digits, punctuation strings, or symbols literally as numbers or sound effect words like "Whoosh". Infer and translate them as natural, powerful screams, shouts, or groans matching character agony and scene intensity.
...
- Unestablished Gender & Direct Scolding:
  * When characters address a baby, child, or person directly (e.g. "고놈", "요놈", "이 녀석", "꼬마"), avoid guessing "he/him" if the gender is unconfirmed in the glossary or context.
  * Prefer natural direct second-person dialogue (e.g. "You little rascal! Taking after your father...") or gender-neutral phrasing ("that little one", "their father") rather than forcing a masculine pronoun.
  * Reflexive possessives like "지 아비" / "지 어미" mean "her/his/their/your father/mother" and must match the subject's gender or direct address context.
...
export function systemPrompt(src: string, tgt: string, _enableSfx = false): string {
	...
	const rules: string[] = [
		...
		`5. Contextual OCR Typo & Degradation Recovery: Source text from comic OCR may contain visually similar stroke confusions, spurious intra-word spaces, or rogue border/bracket symbols (| / \\ ~ [ ] o] c]). Never translate corrupted OCR text literally if it produces nonsensical dialogue or broken words. When dialogue bubbles contain elongated screams, agony groans, or shouts degraded into random numbers, punctuation, or single letters, infer and translate the natural vocalization (e.g. "Aaaargh!!", "Gwaaaah!!", "Uwaaaah!!") instead of translating digits or artifact characters literally.`,
