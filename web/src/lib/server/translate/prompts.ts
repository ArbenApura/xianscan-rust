...
- Modern Manhua Brand & Platform Parodies: Comic dialogue often features homophone puns of well-known apps, platforms, and services (e.g. 美困 for Meituan 美团 / 美团跑腿 errand runners, 拼夕夕 for Pinduoduo 拼多多, 掏宝 for Taobao 淘宝). Translate the underlying real-world service concept (e.g. "Meikun delivery runners", "on-demand errand couriers") rather than inventing bizarre literal fantasy terms like "beauty pageant contestants".
...
export function systemPrompt(
	...
	const coreInvariants: string[] = [
		...
		`     * Bluff, Cover Story & Gullibility Reactions: When a character tells a lie, excuse, or bluff and the conversation partner naively buys it (e.g. "哦哦", "原来如此"), short reaction phrases, callout tags, or inner murmurs like "真信了" / "信了" / "真好骗" / "真当真了" / "骗过去了" refer to the gullible listener who bought the story ("He actually bought it!", "He totally fell for it!", "He really believed that!"), NEVER first-person ("I actually believed it").`,
		...
		`   - Region Kind Semantics (dialogue_bubble vs. free_text):`,
		`     * dialogue_bubble (default): Main character speech or internal thoughts within balloon borders. Apply standard dialogue registers and conversational pro-drop resolution.`,
		`     * free_text: Non-bubble text. Differentiate carefully between:`,
