...
- **100% Free & Unlimited Local AI** (<img src="https://cdn.simpleicons.org/ollama/ffffff" width="16" height="16" alt="Ollama" /> **Ollama** / **LM Studio**):
  - <img src="https://cdn.jsdelivr.net/npm/@lobehub/icons-static-svg@latest/icons/qwen-color.svg" width="16" height="16" alt="Qwen" /> **Qwen 2.5 (3B / 7B / 14B)**: The leading lightweight model for CJK (Chinese, Japanese, Korean) translation, cultural idiom accuracy, and comic dialogue understanding.
  - <img src="https://cdn.simpleicons.org/meta/0081FB" width="16" height="16" alt="Meta Llama" /> **Llama 3.2 (1B / 3B)**: Ultra-fast and lightweight inference engineered for low-latency execution on minimal hardware (~2–4 GB RAM).
  - <img src="https://cdn.jsdelivr.net/npm/@lobehub/icons-static-svg@latest/icons/gemma-color.svg" width="16" height="16" alt="Google Gemma" /> **Gemma 2 (2B / 9B)** & <img src="https://cdn.simpleicons.org/mistralai/FF7000" width="16" height="16" alt="Mistral AI" /> **Mistral (7B)**: Clean reasoning and high-fidelity dialogue translation.
- **Cloud AI APIs**: Compatible with standard OpenAI-compatible endpoints, <img src="https://cdn.simpleicons.org/googlegemini/8E75FF" width="16" height="16" alt="Google Gemini" /> **Google AI Studio (Gemini)**, <img src="https://cdn.simpleicons.org/groq/F55036" width="16" height="16" alt="Groq" /> **Groq** (instant ultra-fast inference), <img src="https://cdn.simpleicons.org/openrouter/6366F1" width="16" height="16" alt="OpenRouter" /> **OpenRouter**, and <img src="https://cdn.simpleicons.org/openai/10A37F" width="16" height="16" alt="OpenAI" /> **OpenAI**.
