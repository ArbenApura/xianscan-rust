...
/// # Reported Case 4: Thought Bubble Tail Circle Digit Stripping
///
/// ## Purpose:
/// Verifies that trailing hallucinated digits (e.g. `200`, `300`) generated by thought bubble
/// trailing circles are cleanly stripped from genuine dialogue sentences.
#[test]
...
/// # Reported Case 5: Normal Dialogue Punctuation Preservation
///
/// ## Purpose:
/// Verifies that standard multi-line dialogue containing punctuation is not damaged by artifact filters.
#[test]
...
/// # Reported Case 7: Pure Standalone Watermark & Tail Circle Classification
///
/// ## Purpose:
/// Verifies that standalone numeric strings representing thought bubble tails (`300`, `200`, `000`, `ooo`)
/// are recognized as discardable artifact regions.
#[test]
...
/// # Reported Case 9: System Notification Prefix Merging
///
/// ## Purpose:
/// Verifies that gaming sound prefixes (`嘟！`) and stat notifications (`恐惧值+0`)
/// on the same horizontal plane merge into a single system card notification.
#[test]
...
/// # Reported Case 11: Single-Character SFX Exclamation Retention
///
/// ## Purpose:
/// Verifies that legitimate single-character sound effects (`咳！`) are not falsely discarded as stray noise.
#[test]
...
/// # Reported Case 22: Dialogue Paragraph Vertical Fragmentation Guard
///
/// ## Purpose:
/// Verifies that multi-line dialogue boxes on the left panel unify vertically
/// while remaining strictly separated from right-panel speech bubbles.
#[test]
