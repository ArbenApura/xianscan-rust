...
fn test_regression_page_lucky_me_first_place_vertical() {
    ...
    // TEXT BOUNDS: [X: 110, Y: 98, W: 90, H: 205] | BUBBLE BOUNDS: [X: 78, Y: 60, W: 168, H: 273]
    ...
    crate::assert_region_bounds!(lucky_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 110, 98, 90, 205, 8);
    crate::assert_bubble_bounds!(lucky_bubble, 78, 60, 168, 273, 10);

    // 2. TOP-CENTER SMALL CIRCLE: 'スゴすぎー'
    // TEXT BOUNDS: [X: 473, Y: 93, W: 42, H: 131] | BUBBLE BOUNDS: [X: 433, Y: 79, W: 118, H: 162]
    ...
    crate::assert_region_bounds!(sugoi_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 473, 93, 42, 131, 8);
    ...
    // TEXT BOUNDS: [X: 989, Y: 77, W: 50, H: 167] | BUBBLE BOUNDS: [X: 944, Y: 48, W: 139, H: 220]
    ...
    crate::assert_region_bounds!(top_right, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 989, 77, 50, 167, 8);
    crate::assert_bubble_bounds!(top_right, 944, 48, 139, 220, 10);

    // 5. MID-LEFT SMALL BUBBLE: 'ハハ・・'
    // TEXT BOUNDS: [X: 185, Y: 681, W: 54, H: 102] | BUBBLE BOUNDS: [X: 157, Y: 667, W: 106, h: 140]
    ...
    crate::assert_region_bounds!(haha_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 185, 681, 54, 102, 8);
    ...
    // TEXT BOUNDS: [X: 966, Y: 981, W: 75, H: 182] | BUBBLE BOUNDS: [X: 935, Y: 959, W: 130, H: 225]
    ...
    crate::assert_region_bounds!(modest_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 966, 981, 75, 182, 8);
    crate::assert_bubble_bounds!(modest_bubble, 935, 959, 130, 225, 10);

    // 10. BOTTOM-CENTER BOY BUBBLE: 'すえ 末は 博士か 大臣か'
    // TEXT BOUNDS: [X: 713, Y: 1321, W: 154, H: 128] | BUBBLE BOUNDS: [X: 701, Y: 1244, W: 172, H: 263]
    ...
    crate::assert_region_bounds!(proverb_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 713, 1321, 154, 128, 8);
