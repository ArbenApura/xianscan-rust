...
fn test_regression_page_lucky_me_first_place_vertical() {
    ...
    // TEXT BOUNDS: [X: 470, Y: 93, W: 48, H: 131] | BUBBLE BOUNDS: [X: 433, Y: 79, W: 118, H: 162]
    ...
    // TEXT BOUNDS: [X: 666, Y: 104, W: 116, H: 150] | BUBBLE BOUNDS: [X: 653, Y: 86, W: 146, H: 184]
    ...
    crate::assert_region_bounds!(entrance_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 666, 104, 116, 150, 8);
    crate::assert_bubble_bounds!(entrance_bubble, 653, 86, 146, 184, 10);

    // 4. TOP-RIGHT BUBBLE: 'また１位！？'
    // TEXT BOUNDS: [X: 985, Y: 63, W: 58, H: 194] | BUBBLE BOUNDS: [X: 944, Y: 48, W: 139, H: 220]
    ...
    // TEXT BOUNDS: [X: 181, Y: 675, W: 62, H: 114] | BUBBLE BOUNDS: [X: 157, Y: 667, W: 106, h: 140]
    ...
    // TEXT BOUNDS: [X: 751, Y: 522, W: 134, H: 242] | BUBBLE BOUNDS: [X: 730, Y: 477, W: 340, H: 305]
    ...
    crate::assert_region_bounds!(eval_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 751, 522, 134, 242, 8);
    crate::assert_bubble_bounds!(eval_bubble, 730, 477, 340, 305, 10);

    // 7. MID-RIGHT TEACHER BUBBLE: 'お前ら 秋田を 見習え～'
    // TEXT BOUNDS: [X: 923, Y: 503, W: 128, H: 164] | BUBBLE BOUNDS: [X: 730, Y: 477, W: 340, H: 305]
    ...
    // TEXT BOUNDS: [X: 960, Y: 970, W: 86, H: 204] | BUBBLE BOUNDS: [X: 935, Y: 959, W: 130, H: 225]
    ...
    // TEXT BOUNDS: [X: 713, Y: 1312, W: 154, H: 146] | BUBBLE BOUNDS: [X: 701, Y: 1244, W: 172, H: 263]
