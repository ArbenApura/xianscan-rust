...
fn test_regression_page_school_phone_rule_e_bubble() {
    ...
    // TEXT BOUNDS: [X: 21, Y: 22, W: 109, H: 146] | BUBBLE BOUNDS: [X: 0, Y: 0, W: 165, H: 219]
    ...
    crate::assert_region_bounds!(all_solved, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 21, 22, 109, 146, 8);
    crate::assert_bubble_bounds!(all_solved, 0, 0, 165, 219, 10);

    // 2. TOP-CENTER SINGLE-CHARACTER BUBBLE: 'え'
    // TEXT BOUNDS: [X: 364, Y: 4, W: 68, H: 96] | BUBBLE BOUNDS: [X: 317, Y: 1, W: 151, H: 132]
    ...
    crate::assert_region_bounds!(e_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 364, 4, 68, 96, 8);
    crate::assert_bubble_bounds!(e_bubble, 317, 1, 151, 132, 10);

    // 3. TOP-RIGHT BUBBLE: '気が ぬけたら 意識 トびそうに なった…'
    // TEXT BOUNDS: [X: 678, Y: 85, W: 132, H: 116] | BUBBLE BOUNDS: [X: 666, Y: 59, W: 141, H: 171]
    ...
    crate::assert_region_bounds!(top_right, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 678, 85, 132, 116, 8);
    crate::assert_bubble_bounds!(top_right, 666, 59, 141, 171, 10);

    // 4. TOP-MIDDLE LEFT BUBBLE: 'あ… うん。'
    // TEXT BOUNDS: [X: 280, Y: 207, W: 57, H: 66] | BUBBLE BOUNDS: [X: 261, Y: 171, W: 246, H: 178]
    ...
    crate::assert_region_bounds!(ah_un, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 280, 207, 57, 66, 8);
    crate::assert_bubble_bounds!(ah_un, 261, 171, 246, 178, 10);

    // 5. TOP-MIDDLE RIGHT BUBBLE: '学校内て スマホ持ち歩くの 校則違反じゃん。'
    // TEXT BOUNDS: [X: 382, Y: 175, W: 85, H: 176] | BUBBLE BOUNDS: [X: 261, Y: 171, W: 246, H: 178]
    ...
    crate::assert_region_bounds!(school_rule, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 382, 175, 85, 176, 8);
    crate::assert_bubble_bounds!(school_rule, 261, 171, 246, 178, 10);

    // 6. BOTTOM-LEFT UPPER BUBBLE: 'いつも つるんでる やつらでも…'
    // TEXT BOUNDS: [X: 72, Y: 420, W: 88, H: 139] | BUBBLE BOUNDS: [X: 36, Y: 403, W: 233, H: 333]
    ...
    crate::assert_region_bounds!(hanging_out, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 72, 420, 88, 139, 8);
    ...
    // TEXT BOUNDS: [X: 103, Y: 576, W: 121, H: 161] | BUBBLE BOUNDS: [X: 36, Y: 403, W: 233, H: 333]
    ...
    crate::assert_region_bounds!(anyone_fine, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 103, 576, 121, 161, 8);
