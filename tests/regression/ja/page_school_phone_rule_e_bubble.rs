...
fn test_regression_page_school_phone_rule_e_bubble() {
    ...
    // TEXT BOUNDS: [X: 355, Y: 4, W: 86, H: 96] | BUBBLE BOUNDS: [X: 317, Y: 1, W: 151, H: 132]
    ...
    crate::assert_region_bounds!(e_bubble, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 355, 4, 86, 96, 8);
    crate::assert_bubble_bounds!(e_bubble, 317, 1, 151, 132, 10);

    // 3. TOP-RIGHT BUBBLE: 'ぬけたら 意識 トびそうに なった…' / '気が ぬけたら 意識 トびそうに なった…'
    // TEXT BOUNDS: [X: 678, Y: 82, W: 127, H: 122] | BUBBLE BOUNDS: [X: 666, Y: 59, W: 141, H: 171]
    ...
    crate::assert_region_bounds!(top_right, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 678, 82, 127, 122, 8);
    crate::assert_bubble_bounds!(top_right, 666, 59, 141, 171, 10);

    // 4. TOP-MIDDLE LEFT BUBBLE: 'あ… うん。'
    // TEXT BOUNDS: [X: 280, Y: 199, W: 57, H: 82] | BUBBLE BOUNDS: [X: 261, Y: 171, W: 246, H: 178]
    ...
    crate::assert_region_bounds!(ah_un, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 280, 199, 57, 82, 8);
    crate::assert_bubble_bounds!(ah_un, 261, 171, 246, 178, 10);

    // 5. TOP-MIDDLE RIGHT BUBBLE: '学校内て スマホ持ち歩くの 校則違反じゃん。'
    // TEXT BOUNDS: [X: 370, Y: 175, W: 108, H: 174] | BUBBLE BOUNDS: [X: 261, Y: 171, W: 246, H: 178]
    ...
    crate::assert_region_bounds!(school_rule, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 370, 175, 108, 174, 8);
    crate::assert_bubble_bounds!(school_rule, 261, 171, 246, 178, 10);

    // 6. BOTTOM-LEFT UPPER BUBBLE: 'いつも つるんでる やつらでも…'
    // TEXT BOUNDS: [X: 67, Y: 420, W: 98, H: 139] | BUBBLE BOUNDS: [X: 36, Y: 403, W: 233, H: 333]
    ...
    crate::assert_region_bounds!(hanging_out, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 67, 420, 98, 139, 8);
    ...
    // TEXT BOUNDS: [X: 93, Y: 576, W: 140, H: 160] | BUBBLE BOUNDS: [X: 36, Y: 403, W: 233, H: 333]
    ...
    crate::assert_region_bounds!(anyone_fine, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 93, 576, 140, 160, 8);
