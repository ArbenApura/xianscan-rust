...
fn test_regression_page_who_is_she_bottom_box() {
    ...
    // TEXT BOUNDS: 'PEREMPUAN...?' -> [X: 38, Y: 508, W: 144, H: 28]
    ...
    crate::assert_region_bounds!(top_box, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 38, 508, 144, 28, 5);
    crate::assert_bubble_bounds!(top_box, 23, 473, 176, 101, 10);

    // 3. LOWER DIALOGUE BOX:
    // TEXT BOUNDS: 'SIAPA DIA...?' -> [X: 212, Y: 921, w: 144, h: 32]
    ...
    crate::assert_region_bounds!(bottom_box, xianscan_rust::ml::schemas::RegionKind::DialogueBubble, 212, 921, 144, 32, 5);
